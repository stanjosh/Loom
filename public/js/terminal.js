import { setVolume } from "/js/util/speak.js";
import { click } from "/js/sound/index.js";
import { on, off } from "/js/util/power.js";
import { toggleFullscreen } from "./util/screens.js";
import { type } from "/js/util/io.js";
...
async function onload() {
	...
	if (command) {
		const { power } = await import("/js/util/power.js");
		const { parse } = await import("/js/util/io.js");
		power();
